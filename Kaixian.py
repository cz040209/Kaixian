...
            st.write(f"An error occurred: {e}"), can u make the login and register page dont use the background image, only the chat page need the background



Got it! Let's apply the background image only to the chat page. Here's the updated code:
...
            st.write(f"An error occurred: {e}"), can u let the login and register page dont have the two voice/video call button, only the chat page need



Alright, let's make those call buttons appear only on the chat page. Here's the updated code:
...
if page == "Login":
    ...
    set_background(background_image_url)
    # Create a container for the call icons at the bottom (only for Chat page)
    call_icon_container = st.container()
    with call_icon_container:
        st.markdown("""
            <div class="fixed-bottom-icons">
